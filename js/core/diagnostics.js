...
function runDeepAudit(){
  ...
  try{
    ok('Versión única',VERSION==='7.8.3'&&NF_RUNTIME.version==='7.8.3'&&window.NF_APP_VERSION==='7.8.3',VERSION);
    ok('Namespace nuevo',KEY==='nutrifamilia_v7_8_3',KEY);
    ok('Cache actual',window.NF_CACHE_NAME==='nutrifamilia-v7.8.3','nutrifamilia-v7.8.3');
...
function NutriFamiliaDeepAudit(){
  ...
  try{
    ...
    add('Identidad de release',VERSION==='7.8.3'&&NF_RUNTIME.version==='7.8.3'&&window.NF_APP_VERSION==='7.8.3',VERSION);
    add('Namespace local nuevo',KEY==='nutrifamilia_v7_8_3',KEY);
    add('Cache PWA nueva',window.NF_CACHE_NAME==='nutrifamilia-v7.8.3',window.NF_CACHE_NAME);
