...
function runDeepAudit(){
  ...
  try{
    ok('Versión única',VERSION==='7.8.5'&&NF_RUNTIME.version==='7.8.5'&&window.NF_APP_VERSION==='7.8.5',VERSION);
    ok('Namespace nuevo',KEY==='nutrifamilia_v7_8_5',KEY);
    ok('Cache actual',window.NF_CACHE_NAME==='nutrifamilia-v7.8.5','nutrifamilia-v7.8.5');
...
function NutriFamiliaDeepAudit(){
  ...
  try{
    ...
    add('Identidad de release',VERSION==='7.8.5'&&NF_RUNTIME.version==='7.8.5'&&window.NF_APP_VERSION==='7.8.5',VERSION);
    add('Namespace local nuevo',KEY==='nutrifamilia_v7_8_5',KEY);
    add('Cache PWA nueva',window.NF_CACHE_NAME==='nutrifamilia-v7.8.5',window.NF_CACHE_NAME);
