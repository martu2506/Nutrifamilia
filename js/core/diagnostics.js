...
function runDeepAudit(){
  ...
  try{
    ok('Versión única',VERSION==='7.8.0'&&NF_RUNTIME.version==='7.8.0'&&window.NF_APP_VERSION==='7.8.0',VERSION);
    ok('Namespace nuevo',KEY==='nutrifamilia_v7_7_0',KEY);
    ok('Cache actual',window.NF_CACHE_NAME==='nutrifamilia-v7.8.0','nutrifamilia-v7.8.0');
...
function NutriFamiliaDeepAudit(){
  ...
  try{
    ...
    add('Identidad de release',VERSION==='7.8.0'&&NF_RUNTIME.version==='7.8.0'&&window.NF_APP_VERSION==='7.8.0',VERSION);
    add('Namespace local nuevo',KEY==='nutrifamilia_v7_7_0',KEY);
    add('Cache PWA nueva',window.NF_CACHE_NAME==='nutrifamilia-v7.8.0',window.NF_CACHE_NAME);
